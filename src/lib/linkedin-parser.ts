...
// Lazy-initialized OpenAI client (prevents build-time errors when API key is not set)
 ...
 * (pdf-parse is a Node.js library, no Python needed)
 */
export async function extractTextFromPdf(pdfBuffer: Buffer): Promise<string> {
  // Dynamic import because pdf-parse uses Node.js APIs
...
/**
 * Send raw LinkedIn profile text to OpenAI GPT-4o
