...
import _styles from "./ButtonMainSecondary.module.css";
...
export function ButtonMainSecondary({ as: _Component = _Builtin.Link }) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "button-main", "is-secondary")}
      data-w-id="45c295eb-044a-5502-ee60-63dd1b5a9cc6"
      button={false}
      block="inline"
      options={{
        href: "#",
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "button-text-main", "is-secondary")}
        tag="div"
      >
        {"Start a Project"}
      </_Builtin.Block>
